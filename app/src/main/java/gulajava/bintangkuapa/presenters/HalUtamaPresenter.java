...
import gulajava.bintangkuapa.databases.RepoHalamanUtama;
import gulajava.bintangkuapa.internets.ApisVolleys;
import gulajava.bintangkuapa.internets.models.Lahiran;
import gulajava.bintangkuapa.internets.volleys.FastJsonRequest;
import gulajava.bintangkuapa.internets.volleys.Volleys;
import gulajava.bintangkuapa.utilans.CekInternet;
...
public class HalUtamaPresenter implements HalUtamaContract.Presenter {
    ...
    public void ambilDataDariInternet() {
        ...
        FastJsonRequest<Lahiran> fastJsonRequest = ApisVolleys.getDataKelahiran(
